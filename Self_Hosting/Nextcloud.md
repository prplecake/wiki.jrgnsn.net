...
server {
    ...
    if ($host = nc.jrgnsn.net) {
        return 301 https://$host$request_uri;
    } # managed by Certbot

    listen 80;
    listen [::]:80;
    server_name nc.jrgnsn.net;
}
...
server {
    ...
    ssl_certificate /etc/letsencrypt/live/nc.jrgnsn.net/fullchain.pem; # managed by Certbot
    ssl_certificate_key /etc/letsencrypt/live/nc.jrgnsn.net/privkey.pem; # managed by Certbot
